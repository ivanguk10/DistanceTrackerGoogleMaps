package com.example.googlemapsapp.ui.result
...
import com.example.googlemapsapp.databinding.FragmentResultBinding
...
class ResultFragment : BottomSheetDialogFragment() {
    ...
    override fun onCreateView(
        ...
        binding.distanceValue.text = getString(R.string.result, args.result.distance)
